class Insult:
    def __init__(self,types):
        ...
        if types == "Style":
            ...
            self.verb=["is", "will be", "eating", "eat", "fight","walking","walk","sleeping","sleep","fall","falling","move","moving","playing"] 
        if types == "Action":
            self.insultFinal=["hope you get hit by a truck and survive", "like a gta character", "you donut", "you precious stuck up bi... du-dude", "you absolute cretin", "hope you step on a lego"]
